...
export class LocationComponent {
  randomLocation$: Observable<cartoonLocation> = this.route.data.pipe(map(data => data['location']))
  protected readonly isCharacterArray = isCharacterArray;
  constructor(private route: ActivatedRoute, private locationSVC: LocationService) {}
